...
class Transcript(object):
    ...
    def __hash__(self):
        return hash((self.name, self.version, self.gene.name, 
                    self.tx_position.chrom, self.tx_position.chrom_start, 
                    self.tx_position.chrom_stop, self.tx_position.is_forward_strand))
    ...
    def __eq__(self, other):
        ...
        return (self.name == other.name and 
                ...
                self.tx_position.chrom == other.tx_position.chrom and
                self.tx_position.chrom_start == other.tx_position.chrom_start and
                self.tx_position.chrom_stop == other.tx_position.chrom_stop and
                self.tx_position.is_forward_strand == other.tx_position.is_forward_strand)
